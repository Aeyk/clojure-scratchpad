...
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_8233})));
...
var temp__5743__auto___8238 = cljs.core.seq.call(null,seq__8225_8229);
if(temp__5743__auto___8238){
var seq__8225_8239__$1 = temp__5743__auto___8238;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__8225_8239__$1)){
var c__4556__auto___8240 = cljs.core.chunk_first.call(null,seq__8225_8239__$1);
var G__8241 = cljs.core.chunk_rest.call(null,seq__8225_8239__$1);
var G__8242 = c__4556__auto___8240;
var G__8243 = cljs.core.count.call(null,c__4556__auto___8240);
var G__8244 = (0);
...
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_8245})));
...
var temp__5741__auto__ = clojure.browser.net.xpc_connection.call(null);
if(cljs.core.truth_(temp__5741__auto__)){
var repl_connection = temp__5741__auto__;
...
var script__$1 = (function (){var G__8254 = script;
goog.object.set(G__8254,"type","text/javascript");

goog.object.set(G__8254,"onload",onload);

goog.object.set(G__8254,"onreadystatechange",onload);

return G__8254;
})();
if((opt_sourceText == null)){
var G__8255 = script__$1;
goog.object.set(G__8255,"src",src);

return G__8255;
} else {
var G__8256 = script__$1;
goog.dom.setTextContent(G__8256,opt_sourceText);
...
var path_8257 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_8257);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_8257)].join(''));
} else {
var path_8258 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_8258);

goog.object.remove(goog.dependencies_.written,path_8258);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_8258)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__8259 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__8260 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__8260);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__8259);
}})()})));
}));
