...
var G__29313 = cljs.spec.alpha.form.call(null,cljs.spec.alpha.get_spec.call(null,x));
x = G__29313;
continue;
} else {
...
var G__29314 = cljs.spec.alpha.form.call(null,x);
x = G__29314;
continue;
} else {
...
var G__29315 = parse_data;
var G__29315__$1 = (((G__29315 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__29315));
var G__29315__$2 = (((G__29315__$1 == null))?null:cljs.core.keep.call(null,spec_tools.parse.get_keys,G__29315__$1));
var G__29315__$3 = (((G__29315__$2 == null))?null:cljs.core.apply.call(null,cljs.core.concat,G__29315__$2));
var G__29315__$4 = (((G__29315__$3 == null))?null:cljs.core.seq.call(null,G__29315__$3));
if((G__29315__$4 == null)){
return null;
} else {
return cljs.core.set.call(null,G__29315__$4);
}
}
});
...
var map__29316 = spec_tools.impl.parse_keys.call(null,form);
...
var req = cljs.core.get.call(null,map__29316__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.call(null,map__29316__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.call(null,map__29316__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.call(null,map__29316__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.call(null,map__29316__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__29318 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set.call(null,cljs.core.concat.call(null,req,opt,req_un,opt_un))], null);
var G__29318__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.call(null,G__29318,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set.call(null,cljs.core.concat.call(null,req,req_un))):G__29318);
...
return cljs.core.assoc.call(null,G__29318__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set.call(null,cljs.core.concat.call(null,opt,opt_un)));
} else {
return G__29318__$1;
}
}));
...
var vec__29319 = multi_spec_form;
...
var multi_method_symbol = first__29321__$1;
var ___$1 = seq__29320__$2;
var form = vec__29319;
var temp__5743__auto__ = cljs.core.first.call(null,cljs.core.filter.call(null,(function (v){
...
return cljs.core.map.call(null,(function (p__29322){
var vec__29323 = p__29322;
var spec_k = cljs.core.nth.call(null,vec__29323,(0),null);
var method = cljs.core.nth.call(null,vec__29323,(1),null);
...
var type_priority = (function (p1__29326_SHARP_){
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__29326_SHARP_).call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(0),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(1)], null),(0));
});
...
var map__29327 = cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.drop.call(null,(2),form));
...
var into = cljs.core.get.call(null,map__29327__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__29329 = cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.drop.call(null,(2),form));
...
var into = cljs.core.get.call(null,map__29329__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
cljs.core._add_method.call(null,spec_tools.parse.parse_form,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__29331){
var vec__29332 = p__29331;
var ___$1 = cljs.core.nth.call(null,vec__29332,(0),null);
var k = cljs.core.nth.call(null,vec__29332,(1),null);
var v = cljs.core.nth.call(null,vec__29332,(2),null);
...
cljs.core._add_method.call(null,spec_tools.parse.parse_form,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__29335){
...
var ___$1 = first__29338;
var values = seq__29337__$1;
...
var type_priority = (function (p1__29339_SHARP_){
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__29339_SHARP_).call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null));
});
return cljs.core.apply.call(null,spec_tools.impl.deep_merge,cljs.core.sort_by.call(null,type_priority,cljs.core.map.call(null,spec_tools.parse.parse_spec,cljs.core.rest.call(null,form))));
}));

//# sourceMappingURL=parse.js.map?rel=1604387922637
