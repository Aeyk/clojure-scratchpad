...
var vec__29243 = cljs.core.rest.call(null,expr);
...
var vec__29246 = first__29245;
var s = cljs.core.nth.call(null,vec__29246,(0),null);
var form = seq__29244__$1;
...
var G__29249 = x;
var G__29249__$1 = (((G__29249 == null))?null:spec_tools.impl.polish.call(null,G__29249));
var G__29249__$2 = (((G__29249__$1 == null))?null:cljs.core.name.call(null,G__29249__$1));
if((G__29249__$2 == null)){
return null;
} else {
return cljs.core.keyword.call(null,G__29249__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__29250 = x;
var G__29250__$1 = (((G__29250 == null))?null:cljs.core.name.call(null,G__29250));
if((G__29250__$1 == null)){
return null;
} else {
return cljs.core.keyword.call(null,G__29250__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__29251){
...
var data = map__29252__$1;
var req = cljs.core.get.call(null,map__29252__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.call(null,map__29252__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.call(null,map__29252__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.call(null,map__29252__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__29254){
...
var data = map__29255__$1;
var req_un = cljs.core.get.call(null,map__29255__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.call(null,map__29255__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__29257 = data;
var G__29257__$1 = (cljs.core.truth_(req_un)?cljs.core.update.call(null,G__29257,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.call(null,cljs.core.mapv,spec_tools.impl.un_key)):G__29257);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.call(null,G__29257__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.call(null,cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__29257__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__29261 = form;
var G__29261__$1 = (((G__29261 == null))?null:cljs.core.rest.call(null,G__29261));
if((G__29261__$1 == null)){
return null;
} else {
return cljs.core.apply.call(null,cljs.core.hash_map,G__29261__$1);
}
})();
var G__29262 = m;
var G__29262__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.call(null,G__29262,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__29258_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.keep.call(null,spec_tools.impl.polish,cljs.core.flatten.call(null,p1__29258_SHARP_)));
})):G__29262);
var G__29262__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.call(null,G__29262__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__29259_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.keep.call(null,spec_tools.impl.polish,cljs.core.flatten.call(null,p1__29259_SHARP_)));
})):G__29262__$1);
var G__29262__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.call(null,G__29262__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__29260_SHARP_){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.keep.call(null,spec_tools.impl.polish,p1__29260_SHARP_));
})):G__29262__$2);
return spec_tools.impl.with_real_keys.call(null,spec_tools.impl.with_key__GT_spec.call(null,G__29262__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__29263 = (function (){var G__29264 = form;
var G__29264__$1 = (((G__29264 == null))?null:cljs.core.rest.call(null,G__29264));
if((G__29264__$1 == null)){
return null;
} else {
return cljs.core.apply.call(null,cljs.core.hash_map,G__29264__$1);
}
})();
...
var req = cljs.core.get.call(null,map__29263__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.call(null,map__29263__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.call(null,map__29263__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.call(null,map__29263__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__29266 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace.call(null,kw):false);
switch (G__29266) {
...
var temp__5741__auto__ = cljs.core.namespace.call(null,key);
...
return cljs.core.boolean$.call(null,((cljs.core.seq_QMARK_.call(null,form))?(function (){var G__29268 = form;
var G__29268__$1 = (((G__29268 == null))?null:cljs.core.seq.call(null,G__29268));
var G__29268__$2 = (((G__29268__$1 == null))?null:cljs.core.first.call(null,G__29268__$1));
if((G__29268__$2 == null)){
return null;
} else {
return new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null).call(null,G__29268__$2);
}
})():null));
});
/**
...
var len__4736__auto___29270 = arguments.length;
var i__4737__auto___29271 = (0);
while(true){
if((i__4737__auto___29271 < len__4736__auto___29270)){
args__4742__auto__.push((arguments[i__4737__auto___29271]));

var G__29272 = (i__4737__auto___29271 + (1));
i__4737__auto___29271 = G__29272;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq29269){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29269));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.call(null,(function (acc,p__29273){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__29279){
...
var req = cljs.core.get.call(null,map__29280__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.call(null,map__29280__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.call(null,map__29280__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.call(null,map__29280__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__29277_SHARP_){
return cljs.core.map_QMARK_.call(null,p1__29277_SHARP_);
})], null),cljs.core.map.call(null,(function (x){
return (function (p1__29278_SHARP_){
return cljs.core.contains_QMARK_.call(null,p1__29278_SHARP_,x);
});
}),req_keys));
...
//# sourceMappingURL=impl.js.map?rel=1604387922347
