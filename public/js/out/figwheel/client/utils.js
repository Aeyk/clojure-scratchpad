...
return (new CustomEvent(event_name,(function (){var obj39855 = ({"detail":data});
return obj39855;
})()));
} else {
...
var f = (function (){var pred__39862 = cljs.core._EQ_;
var expr__39863 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39862.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39863))){
return (function (p1__39856_SHARP_){
return console.warn(p1__39856_SHARP_);
});
} else {
if(cljs.core.truth_(pred__39862.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39863))){
return (function (p1__39857_SHARP_){
return console.debug(p1__39857_SHARP_);
});
} else {
if(cljs.core.truth_(pred__39862.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39863))){
return (function (p1__39858_SHARP_){
return console.error(p1__39858_SHARP_);
});
} else {
return (function (p1__39859_SHARP_){
return console.log(p1__39859_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__39866){
...
var opts = map__39867__$1;
var eval_fn = cljs.core.get.call(null,map__39867__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__39869_SHARP_){
return new_def.callback(p1__39869_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__39870){
var vec__39871 = p__39870;
var ky = cljs.core.nth.call(null,vec__39871,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1604387941112
