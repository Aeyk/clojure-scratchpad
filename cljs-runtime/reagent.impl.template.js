...
var temp__5745__auto__ = reagent.impl.template.cache_get(reagent.impl.template.prop_name_cache,cljs.core.name(k));
...
var k_SINGLEQUOTE_ = temp__5745__auto__;
...
var G__55578 = o;
goog.object.set(G__55578,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__55611__delegate = function (args){
...
while (G__55612__i < G__55612__a.length) {G__55612__a[G__55612__i] = arguments[G__55612__i + 0]; ++G__55612__i;}
  args = new cljs.core.IndexedSeq(G__55612__a,0,null);
} 
return G__55611__delegate.call(this,args);};
G__55611.cljs$lang$maxFixedArity = 0;
G__55611.cljs$lang$applyTo = (function (arglist__55613){
var args = cljs.core.seq(arglist__55613);
return G__55611__delegate(args);
});
...
if(reagent.impl.util.named_QMARK_(k)){
var temp__5745__auto__ = reagent.impl.template.cache_get(reagent.impl.template.custom_prop_name_cache,cljs.core.name(k));
if((temp__5745__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
...
var G__55582 = o;
goog.object.set(G__55582,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__55583 = props;
var G__55583__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55583,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__55583);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55583__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__55583__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__55584 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55584,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__55584;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__55585){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55586__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__55588_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__55588_SHARP_);
}));
} else {
return null;
}
...
var vec__55590 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55590,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55590,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55590,(2),null);
...
var temp__5745__auto__ = reagent.impl.template.get_key(cljs.core.meta(v));
if((temp__5745__auto__ == null)){
return reagent.impl.template.get_key(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(1),null));
} else {
var k = temp__5745__auto__;
return k;
}
});
...
var temp__5747__auto___55650 = reagent.impl.template.key_from_vec(v);
if((temp__5747__auto___55650 == null)){
} else {
var key_55651 = temp__5747__auto___55650;
(jsprops.key = key_55651);
}
...
var temp__5747__auto___55652 = reagent.impl.template.key_from_vec(argv);
if((temp__5747__auto___55652 == null)){
} else {
var key_55653 = temp__5747__auto___55652;
(jsprops.key = key_55653);
}
...
var temp__5745__auto__ = reagent.impl.template.cache_get(reagent.impl.template.tag_name_cache,x);
if((temp__5745__auto__ == null)){
...
var G__55594 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__55594) : reagent.impl.template.as_element.call(null,G__55594));
} else {
var temp__5747__auto___55656 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5747__auto___55656 == null)){
} else {
var key_55657 = temp__5747__auto___55656;
(jsprops.key = key_55657);
}
...
var G__55596 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__55596)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__55596)){
return x;
} else {
...
var len__4736__auto___55658 = arguments.length;
var i__4737__auto___55659 = (0);
while(true){
if((i__4737__auto___55659 < len__4736__auto___55658)){
args__4742__auto__.push((arguments[i__4737__auto___55659]));

var G__55660 = (i__4737__auto___55659 + (1));
i__4737__auto___55659 = G__55660;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq55597){
var G__55598 = cljs.core.first(seq55597);
var seq55597__$1 = cljs.core.next(seq55597);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55598,seq55597__$1);
}));
...
break;
default:
var G__55662 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__55662;
continue;
...
var ctx = ({});
var vec__55601 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55601,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55601,(1),null);
...
var G__55604 = (cljs.core.count(argv) - first_child);
switch (G__55604) {
case (0):
