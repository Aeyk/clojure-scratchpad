...
var len__4736__auto___41864 = arguments.length;
var i__4737__auto___41865 = (0);
while(true){
if((i__4737__auto___41865 < len__4736__auto___41864)){
args__4742__auto__.push((arguments[i__4737__auto___41865]));

var G__41867 = (i__4737__auto___41865 + (1));
i__4737__auto___41865 = G__41867;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq41787){
var G__41788 = cljs.core.first(seq41787);
var seq41787__$1 = cljs.core.next(seq41787);
var G__41789 = cljs.core.first(seq41787__$1);
var seq41787__$2 = cljs.core.next(seq41787__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41788,G__41789,seq41787__$2);
}));
...
args__4742__auto__.push((arguments[i__4737__auto___41870]));

var G__41872 = (i__4737__auto___41870 + (1));
i__4737__auto___41870 = G__41872;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq41798){
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq41802){
var G__41803 = cljs.core.first(seq41802);
var seq41802__$1 = cljs.core.next(seq41802);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41803,seq41802__$1);
}));
...
var i__4737__auto___41880 = (0);
while(true){
if((i__4737__auto___41880 < len__4736__auto___41879)){
args__4742__auto__.push((arguments[i__4737__auto___41880]));

var G__41881 = (i__4737__auto___41880 + (1));
i__4737__auto___41880 = G__41881;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq41808){
var G__41809 = cljs.core.first(seq41808);
var seq41808__$1 = cljs.core.next(seq41808);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41809,seq41808__$1);
}));
...
while(true){
if((i__4737__auto___41892 < len__4736__auto___41890)){
args__4742__auto__.push((arguments[i__4737__auto___41892]));

var G__41893 = (i__4737__auto___41892 + (1));
i__4737__auto___41892 = G__41893;
continue;
} else {
}
break;
...
var init = (function (){var G__41827 = kind;
var G__41827__$1 = (((G__41827 instanceof cljs.core.Keyword))?G__41827.fqn:null);
switch (G__41827__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41827__$1)].join('')));
...
var G__41825 = cljs.core.first(seq41823__$1);
var seq41823__$2 = cljs.core.next(seq41823__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41824,G__41825,seq41823__$2);
}));
...
var iter__4529__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41849(s__41850){
return (new cljs.core.LazySeq(null,(function (){
var s__41850__$1 = s__41850;
while(true){
var temp__5743__auto__ = cljs.core.seq(s__41850__$1);
if(temp__5743__auto__){
var s__41850__$2 = temp__5743__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41850__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__41850__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__41852 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__41851 = (0);
while(true){
if((i__41851 < size__4528__auto__)){
var vec__41853 = cljs.core._nth(c__4527__auto__,i__41851);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41853,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41853,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__41852,id);

var G__41911 = (i__41851 + (1));
i__41851 = G__41911;
continue;
} else {
var G__41912 = (i__41851 + (1));
i__41851 = G__41912;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41852),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41849(cljs.core.chunk_rest(s__41850__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41852),null);
}
} else {
var vec__41856 = cljs.core.first(s__41850__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41856,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41856,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41849(cljs.core.rest(s__41850__$2)));
} else {
var G__41913 = cljs.core.rest(s__41850__$2);
s__41850__$1 = G__41913;
continue;
}
}
} else {
