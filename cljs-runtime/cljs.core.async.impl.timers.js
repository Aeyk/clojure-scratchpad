...
var i_43565 = (0);
while(true){
if((i_43565 < arr.length)){
(arr[i_43565] = null);

var G__43566 = (i_43565 + (1));
i_43565 = G__43566;
continue;
} else {
}
...
var i_43589 = (self__.level + (1));
while(true){
if((i_43589 <= (new_level + (1)))){
(update[i_43589] = self__.header);

var G__43590 = (i_43589 + (1));
i_43589 = G__43590;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43591 = (update[i]).forward;
(x__$2.forward[i] = (links_43591[i]));
...
var i_43602 = (0);
while(true){
if((i_43602 <= self__.level)){
var links_43603 = (update[i_43602]).forward;
if((x__$1 === (((i_43602 < links_43603.length))?(links_43603[i_43602]):null))){
(links_43603[i_43602] = (x__$1.forward[i_43602]));

var G__43604 = (i_43602 + (1));
i_43602 = G__43604;
continue;
} else {
var G__43605 = (i_43602 + (1));
i_43602 = G__43605;
continue;
}
} else {
