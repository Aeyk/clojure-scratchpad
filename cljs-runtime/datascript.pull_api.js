...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51082__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51082__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__51090 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__51090__$1 = (((G__51090 == null))?null:cljs.core.persistent_BANG_(G__51090));
if((G__51090__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__51090__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__51107){
...
var frame = first__51110;
var frames = seq__51109__$1;
var temp__5741__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5741__auto__){
var eids = temp__5741__auto__;
...
var results = (function (){var G__51116 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__51116,kvps);
} else {
return G__51116;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51117__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51117__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_51213 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_51213,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__51123){
...
var parent = first__51126;
var frames = seq__51125__$1;
...
var found = cljs.core.not_empty((function (){var G__51127 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__51127);
} else {
return G__51127;
}
})());
...
var as_value = (function (){var G__51128 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__51122_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__51122_SHARP_]);
}),G__51128);
} else {
return G__51128;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__51130 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__51130);
} else {
return G__51130;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__51134 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__51134,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__51134;
}
})());
...
var vec__51140 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51140,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51140,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__51144){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__51152){
...
var frame = first__51155;
var frames = seq__51154__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__51156){
...
var frame = first__51159;
var frames = seq__51158__$1;
var temp__5741__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"datoms","datoms",-290874434).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5741__auto__){
var datoms_by_attr = temp__5741__auto__;
var vec__51163 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51163,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51163,(1),null);
...
var temp__5741__auto____$1 = cljs.core.not_empty(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,datascript.pull_api.filter_reverse_attrs,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(frame,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423),new cljs.core.Keyword(null,"attrs","attrs",-2090668713)], null))));
if(cljs.core.truth_(temp__5741__auto____$1)){
var rattrs = temp__5741__auto____$1;
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51166__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51166__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__51168 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__51168,attr,eid);
} else {
return G__51168;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51170__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51170__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__51180){
while(true){
...
var frame = first__51183;
var frames = seq__51182__$1;
var temp__5741__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5741__auto__){
var eids = temp__5741__auto__;
...
var temp__5741__auto____$1 = cljs.core.seq(new cljs.core.Keyword(null,"specs","specs",1426570741).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5741__auto____$1){
var specs = temp__5741__auto____$1;
...
var G__51231 = db;
var G__51232 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__51231;
p__51180 = G__51232;
continue;
}
...
while(true){
var G__51189 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__51189__$1 = (((G__51189 instanceof cljs.core.Keyword))?G__51189.fqn:null);
switch (G__51189__$1) {
case "expand":
var G__51237 = db;
var G__51238 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__51237;
frames = G__51238;
continue;
...
case "expand-rev":
var G__51239 = db;
var G__51240 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__51239;
frames = G__51240;
continue;
...
case "pattern":
var G__51241 = db;
var G__51242 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__51241;
frames = G__51242;
continue;
...
case "recursion":
var G__51243 = db;
var G__51244 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__51243;
frames = G__51244;
continue;
...
var f = first__51192;
var remaining = seq__51191__$1;
var result = (function (){var G__51193 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__51193);
} else {
return G__51193;
}
})();
...
var G__51245 = db;
var G__51246 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__51194 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__51194,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__51194;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51189__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__51195_SHARP_){
return datascript.db.entid_strict(db,p1__51195_SHARP_);
})),eids);
