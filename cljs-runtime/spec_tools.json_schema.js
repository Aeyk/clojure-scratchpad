...
var temp__5741__auto__ = (function (){var and__4115__auto__ = infer_titles_QMARK_(options);
...
var map__57681 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57681__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57681__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57681__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57681__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__57683 = spec_tools.parse.parse_spec(form);
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57683__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__57685 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57685__$1)].join('')));
...
var vec__57700 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57700,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57700,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57700,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57700,(3),null);
...
var vec__57712 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57712,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57712,(1),null);
...
var extra_info = (function (){var G__57719 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57719,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__57719;
}
})();
