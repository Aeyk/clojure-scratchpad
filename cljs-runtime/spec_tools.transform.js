...
if((x instanceof cljs.core.Keyword)){
var G__56312 = spec;
var G__56313 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__56312,G__56313) : f.call(null,G__56312,G__56313));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__56314 = spec;
var G__56315 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__56314,G__56315) : f.call(null,G__56314,G__56315));
} else {
return x;
...
if(typeof x === 'number'){
var G__56318 = spec;
var G__56319 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__56318,G__56319) : f.call(null,G__56318,G__56319));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__56330,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56331__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__56333,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56334__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__56336,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56337__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
