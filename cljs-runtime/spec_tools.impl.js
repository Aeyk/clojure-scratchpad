...
var vec__56192 = cljs.core.rest(expr);
...
var vec__56195 = first__56194;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56195,(0),null);
var form = seq__56193__$1;
...
var G__56199 = x;
var G__56199__$1 = (((G__56199 == null))?null:spec_tools.impl.polish(G__56199));
var G__56199__$2 = (((G__56199__$1 == null))?null:cljs.core.name(G__56199__$1));
if((G__56199__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__56199__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__56205 = x;
var G__56205__$1 = (((G__56205 == null))?null:cljs.core.name(G__56205));
if((G__56205__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__56205__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__56206){
...
var data = map__56210__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56210__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56210__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56210__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56210__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__56212){
...
var data = map__56213__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56213__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56213__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__56221 = data;
var G__56221__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56221,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__56221);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56221__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__56221__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__56235 = form;
var G__56235__$1 = (((G__56235 == null))?null:cljs.core.rest(G__56235));
if((G__56235__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__56235__$1);
}
})();
var G__56236 = m;
var G__56236__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56236,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__56228_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__56228_SHARP_)));
})):G__56236);
var G__56236__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56236__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__56229_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__56229_SHARP_)));
})):G__56236__$1);
var G__56236__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__56236__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__56230_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__56230_SHARP_));
})):G__56236__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__56236__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__56237 = (function (){var G__56238 = form;
var G__56238__$1 = (((G__56238 == null))?null:cljs.core.rest(G__56238));
if((G__56238__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__56238__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56237__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56237__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56237__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56237__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__56240 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__56240) {
...
var temp__5741__auto__ = cljs.core.namespace(key);
if(cljs.core.truth_(temp__5741__auto__)){
var nn = temp__5741__auto__;
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__56241 = form;
var G__56241__$1 = (((G__56241 == null))?null:cljs.core.seq(G__56241));
var G__56241__$2 = (((G__56241__$1 == null))?null:cljs.core.first(G__56241__$1));
if((G__56241__$2 == null)){
return null;
} else {
var fexpr__56242 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__56242.cljs$core$IFn$_invoke$arity$1 ? fexpr__56242.cljs$core$IFn$_invoke$arity$1(G__56241__$2) : fexpr__56242.call(null,G__56241__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq56243){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56243));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__56245){
var vec__56246 = p__56245;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56246,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56246,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__56255){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56256__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56256__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56256__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56256__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__56252_SHARP_){
return cljs.core.map_QMARK_(p1__56252_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__56253_SHARP_){
return cljs.core.contains_QMARK_(p1__56253_SHARP_,x);
});
}),req_keys));
