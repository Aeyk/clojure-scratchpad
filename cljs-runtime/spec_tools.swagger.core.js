...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__57724){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57725__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57725__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__57727 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57727,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57727,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57732 = cljs.core.get_global_hierarchy;
return (fexpr__57732.cljs$core$IFn$_invoke$arity$0 ? fexpr__57732.cljs$core$IFn$_invoke$arity$0() : fexpr__57732.call(null));
})());
...
var map__57733 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57733__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57733__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__57735){
var vec__57736 = p__57735;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57736,(0),null);
var map__57739 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57736,(1),null);
...
var schema = map__57739__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57739__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__57741 = cljs.core.get_global_hierarchy;
return (fexpr__57741.cljs$core$IFn$_invoke$arity$0 ? fexpr__57741.cljs$core$IFn$_invoke$arity$0() : fexpr__57741.call(null));
})());
...
})(),(function (){var iter__4529__auto__ = (function spec_tools$swagger$core$iter__57742(s__57743){
return (new cljs.core.LazySeq(null,(function (){
var s__57743__$1 = s__57743;
while(true){
var temp__5743__auto__ = cljs.core.seq(s__57743__$1);
if(temp__5743__auto__){
var s__57743__$2 = temp__5743__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57743__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__57743__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__57745 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__57744 = (0);
while(true){
if((i__57744 < size__4528__auto__)){
var vec__57746 = cljs.core._nth(c__4527__auto__,i__57744);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57746,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57746,(1),null);
cljs.core.chunk_append(b__57745,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57745),spec_tools$swagger$core$iter__57742(cljs.core.chunk_rest(s__57743__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57745),null);
}
} else {
var vec__57749 = cljs.core.first(s__57743__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57749,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57749,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__57742(cljs.core.rest(s__57743__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__57752){
var vec__57753 = p__57752;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57753,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57753,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__57757,p){
var vec__57758 = p__57757;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57758,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57758,(1),null);
var acc__$1 = vec__57758;
