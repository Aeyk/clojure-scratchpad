...
if((i < len)){
var k = (ks[i]);
var G__55570 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__55571 = (i + (1));
m = G__55570;
i = G__55571;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__55557 = c;
var G__55557__$1 = (((G__55557 == null))?null:G__55557.prototype);
if((G__55557__$1 == null)){
return null;
} else {
return G__55557__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__55559 = c;
var G__55559__$1 = (((G__55559 == null))?null:G__55559.prototype);
if((G__55559__$1 == null)){
return null;
} else {
return G__55559__$1.render;
}
})() == null)))));
});
...
var G__55561 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__55561) : reagent.impl.component.as_element.call(null,G__55561));
};
...
var G__55562 = c;
var G__55562__$1 = (((G__55562 == null))?null:G__55562.constructor);
if((G__55562__$1 == null)){
return null;
} else {
return G__55562__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__55563 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__55564 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__55564);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__55563);
}});
...
return f.call(null,(function (){var temp__5745__auto__ = props.argv;
if((temp__5745__auto__ == null)){
return props;
} else {
var a = temp__5745__auto__;
...
var c = this;
var G__55568_55579 = goog.object.get(c,"cljsRatom");
if((G__55568_55579 == null)){
} else {
reagent.ratom.dispose_BANG_(G__55568_55579);
}
...
var renders_55580 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_55581 = cljs.core.first(cljs.core.vals(renders_55580));
...
if((cljs.core.count(renders_55580) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_55580))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_55581)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_55581], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__55569 = o;
goog.object.set(G__55569,cljs.core.name(k),v);
...
var temp__5745__auto__ = reagent.impl.component.cached_react_class(tag);
if((temp__5745__auto__ == null)){
return reagent.impl.component.fn_to_class(tag);
} else {
var cached_class = temp__5745__auto__;
return cached_class;
}
});
