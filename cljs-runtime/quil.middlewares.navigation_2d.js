...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3((user_setup.cljs$core$IFn$_invoke$arity$0 ? user_setup.cljs$core$IFn$_invoke$arity$0() : user_setup.call(null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611)], null),(function (p1__46535_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__46535_SHARP_], 0));
}));
});
/**
...
var nav_2d_46540 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_46541 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_46540);
var pos_46542 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_46540);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_46541);

var tr__46441__auto___46543 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_46541) - cljs.core.first(pos_46542)),(((quil.core.height() / (2)) / zoom_46541) - cljs.core.second(pos_46542))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__46441__auto___46543);
...
var G__46536 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__46537 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__46536,G__46537) : user_mouse_dragged.call(null,G__46536,G__46537));
}),new cljs.core.Keyword(null,"mouse-wheel","mouse-wheel",1811662439),(function (state,event){
var G__46538 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__46539 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__46538,G__46539) : user_mouse_wheel.call(null,G__46538,G__46539));
})], 0));
});
