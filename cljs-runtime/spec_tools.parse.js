...
var fexpr__56258 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__56258.cljs$core$IFn$_invoke$arity$1 ? fexpr__56258.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56258.call(null,type));
});
...
var G__56308 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__56308;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__56259 = spec_tools.impl.normalize_symbol(x);
var G__56260 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__56259,G__56260) : spec_tools.parse.parse_form.call(null,G__56259,G__56260));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__56261 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__56262 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__56261,G__56262) : spec_tools.parse.parse_form.call(null,G__56261,G__56262));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__56310 = cljs.spec.alpha.form(x);
x = G__56310;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__56263 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__56264 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__56263,G__56264) : spec_tools.parse.parse_form.call(null,G__56263,G__56264));
} else {
...
var G__56266 = parse_data;
var G__56266__$1 = (((G__56266 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__56266));
var G__56266__$2 = (((G__56266__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__56266__$1));
var G__56266__$3 = (((G__56266__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__56266__$2));
var G__56266__$4 = (((G__56266__$3 == null))?null:cljs.core.seq(G__56266__$3));
if((G__56266__$4 == null)){
return null;
} else {
return cljs.core.set(G__56266__$4);
}
}
});
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56267 = cljs.core.get_global_hierarchy;
return (fexpr__56267.cljs$core$IFn$_invoke$arity$0 ? fexpr__56267.cljs$core$IFn$_invoke$arity$0() : fexpr__56267.call(null));
})());
...
var map__56271 = spec_tools.impl.parse_keys(form);
var map__56271__$1 = (((((!((map__56271 == null))))?(((((map__56271.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56271.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56271):map__56271);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56271__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56271__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56271__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56271__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56271__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__56273 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__56273__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56273,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__56273);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56273__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__56273__$1;
}
}));
...
var vec__56274 = multi_spec_form;
var seq__56275 = cljs.core.seq(vec__56274);
var first__56276 = cljs.core.first(seq__56275);
var seq__56275__$1 = cljs.core.next(seq__56275);
var _ = first__56276;
var first__56276__$1 = cljs.core.first(seq__56275__$1);
var seq__56275__$2 = cljs.core.next(seq__56275__$1);
var multi_method_symbol = first__56276__$1;
var ___$1 = seq__56275__$2;
var form = vec__56274;
var temp__5743__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (v){
...
var spec = temp__5743__auto__;
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__56285){
var vec__56286 = p__56285;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56286,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56286,(1),null);
...
var type_priority = (function (p1__56289_SHARP_){
var G__56291 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(0),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(1)], null);
var G__56292 = (0);
var fexpr__56290 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__56289_SHARP_);
return (fexpr__56290.cljs$core$IFn$_invoke$arity$2 ? fexpr__56290.cljs$core$IFn$_invoke$arity$2(G__56291,G__56292) : fexpr__56290.call(null,G__56291,G__56292));
});
...
var map__56293 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56293__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__56295 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56295__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__56297){
var vec__56298 = p__56297;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56298,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56298,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56298,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__56301){
var vec__56302 = p__56301;
var seq__56303 = cljs.core.seq(vec__56302);
var first__56304 = cljs.core.first(seq__56303);
var seq__56303__$1 = cljs.core.next(seq__56303);
var ___$1 = first__56304;
var values = seq__56303__$1;
...
var type_priority = (function (p1__56305_SHARP_){
var G__56307 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__56306 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__56305_SHARP_);
